...
Always ensure to use the required tools for adding services such as ancillary options (e.g., priority boarding) to existing bookings.
...
Ensure to provide compensation policy information using the 'retrieve_compensation_policy' tool rather than requesting additional personal information unless it is necessary for verification.
