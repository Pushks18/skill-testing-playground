from eval.schemas import EvalResult, ABResult, GateDecision, SkillCoverageMetrics, TrajectoryFeatures, FailureClassification, LayerCluster
...
def test_failure_classification_layer_literal():
    ...
    assert c.evidence == {"called_any_tool": False}
