...
| KEEP | disruption-102 | baseline-fail | I need to find out if there's any compensation for my delayed flight AB1234. |  |
...
| KEEP | disruption-110 | baseline-fail | Could you cancel my booking with reference GH8K4J2P? | cancel_booking |
