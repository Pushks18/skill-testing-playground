...
| KEEP | edge-mixed-102 | baseline-fail | Cancel my booking with reference number BK65432109. | cancel_booking |
| KEEP | edge-mixed-103 | baseline-fail | I want to change my flight on BK89345678 to September 30, 2026. | modify_booking |
| KEEP | edge-mixed-104 | baseline-fail | Book me a flight from Miami to Houston on September 1 and then from Houston to San Francisco on Sept | search_flights |
| KEEP | edge-mixed-105 | baseline-fail | I need more details to check the refund for my reservation BK998877. Can you help? |  |
| KEEP | edge-mixed-106 | baseline-fail | Find flights from LAX to SFO on November 15th, and from SFO to LAS on November 18th. Are there any o | search_flights |
